...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(description="MAPPO for Strike-EA (dual-policy, dual-value)")
    # Counts
    ...
    p.add_argument("--save_name", type=str, default="mappo_actor.pt")
...
def main() -> None:
    ...
    base_env, actor, critic, logs, reward_normalizer = train_mappo(
        cfg.env,
        cfg.ppo,
        cfg.net,
