...
class EnvConfig:
    ...
    # Kinematics define action semantics: 6 discrete dimensions mapped to accelerations
    v_max: float = 0.02
    ...
    # Discrete acceleration magnitude per action dimension (3 velocity dims available)
