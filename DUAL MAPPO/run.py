...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(description="Dual-MAPPO for Strike-EA (separate striker & jammer MAPPO)")
    # Counts
    ...
    # Network (shared architecture config between both roles)
    ...
    p.add_argument("--save_name", type=str, default="dual_mappo.pt")
